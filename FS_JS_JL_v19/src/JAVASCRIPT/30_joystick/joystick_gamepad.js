...
function updateForcesFromJoystickOrKeyboard() {
    ...
    if (joystick) {
        ...
        thrust_lever = -30 * joystick.axes[1]; // Left stick vertical

        aileron_input = -0.1 * joystick.axes[2]; // Right stick horizontal
        elevator_input = 0.1 * joystick.axes[0]; // Right stick vertical
        rudder_input = 0.1 * joystick.axes[3]; // Left stick horizontal
